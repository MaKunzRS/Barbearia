 ...
 * @author mateus
 */
public class TelaPDFFuncionarios extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaPDF
     */
    public TelaPDFFuncionarios() {
        initComponents();
    }
    ...
    private void btnCaminhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCaminhoActionPerformed
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            txtCaminho.setText(dir.getAbsolutePath() + "/funcionarios.pdf");
        }
    ...
    private void btnPdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPdfActionPerformed
        ...
        if (caminho.isEmpty()) {
            ...
            try {
                String[] ordem = {
                    "id", "nome", "cargo", "telefone", "salario"
                };
                String[] rotulos = {
