 ...
 */
/**
 * Testa a classe ClienteDAO usando os dados de db-test: 1) Cria tabela cliente
 * em @BeforeClass 2) No @Before, limpa o conteúdo da tabela antes de cada teste
 * 3) Executa os testes 4) Em @AfterClass, dropa a tabela e fecha a conexão
 */
public class ClienteDAOTest {
    ...
    /**
     * Executa ANTES de cada método @Test. Instancia o DAO e limpa a tabela para
     * isolar cada teste.
     */
    @Before
    public void setUp() {
    ...
    /**
     * Executa APÓS cada método @Test. Fecha a conexão para garantir que o
     * próximo teste comece do zero.
     */
    @After
    ...
    /**
     * Testa a inserção de um cliente: 1) Insere um cliente via dao.salvar 2)
     * Recupera todos os clientes e valida a existencia de somente 1 3) Recupera
     * via dao.recuperar(1) e valida a alteração
     */
    @Test
    public void testInserirERetornarCliente() throws SQLException {
        ...
        c.setDataNascimento("1990-05-20");
        c.setTelefone("(51)98588-5478");
        dao.salvar(c);
        ...
        assertEquals(c.getDataNascimento(), recuperado.getDataNascimento());
        assertEquals(c.getTelefone(), recuperado.getTelefone());
    }

    /**
     * Testa a edição de um cliente com ID = 1: 1) Insere um cliente inicial 2)
     * Altera nome e endereço via dao.editar(...) 3) Recupera via
     * dao.recuperar(1) e valida a alteração
     */
    @Test
    public void testEditarCliente() throws SQLException {
        ...
        c.setEmail("teste@teste.com");
        c.setDataNascimento("1980-12-01");
        c.setTelefone("(51)98789-8568");
        dao.salvar(c);
        ...
        modificado.setEmail("teste@teste.com");      // novo email
        modificado.setDataNascimento("1980-12-01");         // mantém data de nascimento
        ...
        assertEquals("teste@teste.com", recuperado.getEmail());
        assertEquals("1980-12-01", recuperado.getDataNascimento());
        assertEquals("(51)98789-8578", recuperado.getTelefone());
    }

    /**
     * Testa a exclusão de um cliente com ID = 1: 1) Insere um cliente inicial
     * 2) Chama dao.excluir(1) 3) Verifica que dao.recuperar(1) retorna null 4)
    ...
    public void testExcluirCliente() throws SQLException {
        ...
        c.setEmail("teste@teste.com");
        c.setDataNascimento("1975-08-15");
        c.setTelefone("(51)98789-8568");
        dao.salvar(c);
